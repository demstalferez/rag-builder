  ...
  return (
    <div className="py-8">
      ...
      <div className="max-w-5xl mx-auto px-4 mb-8">
        <div className="bg-white  rounded-xl border border-slate-200  p-6">
          ...
          <div className="grid md:grid-cols-2 gap-2 text-sm">
            <a href="#introduccion" className="text-slate-600  hover:text-amber-600 py-1">
              1. Contexto: IA en el CSIC
            </a>
            <a href="#ai-act" className="text-slate-600  hover:text-amber-600 py-1">
              2. Reglamento de IA (AI Act)
            </a>
            <a href="#rgpd" className="text-slate-600  hover:text-amber-600 py-1">
              3. RGPD en Proyectos de IA
            </a>
            <a href="#checklist" className="text-slate-600  hover:text-amber-600 py-1">
              4. Checklist de Cumplimiento
            </a>
            <a href="#recursos" className="text-slate-600  hover:text-amber-600 py-1">
      ...
      <div className="max-w-5xl mx-auto px-4 space-y-8">
        ...
        <section id="introduccion" className="bg-white  rounded-xl border border-slate-200  p-6">
          <h2 className="text-2xl font-bold text-slate-900  mb-4 flex items-center">
            <span className="w-8 h-8 bg-amber-100  rounded-lg flex items-center justify-center mr-3 text-amber-600  text-sm font-bold">1</span>
          ...
          <div className="prose  max-w-none">
            ...
            <div className="mt-6 p-4 bg-primary-50  border border-primary-200  rounded-lg">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
                <span className="px-2 py-1 bg-white  rounded text-primary-700 ">Python & SQL</span>
                <span className="px-2 py-1 bg-white  rounded text-primary-700 ">Machine Learning</span>
                <span className="px-2 py-1 bg-white  rounded text-primary-700 ">ETL & RAG</span>
                <span className="px-2 py-1 bg-white  rounded text-primary-700 ">LLMs & Vision</span>
                <span className="px-2 py-1 bg-white  rounded text-primary-700 ">Azure Cloud</span>
                <span className="px-2 py-1 bg-white  rounded text-primary-700 ">Power BI</span>
                <span className="px-2 py-1 bg-white  rounded text-primary-700 ">n8n Automation</span>
                <span className="px-2 py-1 bg-white  rounded text-primary-700 ">Microsoft Fabric</span>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Section 2: AI Act */}
        <section id="ai-act" className="bg-white  rounded-xl border border-slate-200  p-6">
          <h2 className="text-2xl font-bold text-slate-900  mb-4 flex items-center">
            <span className="w-8 h-8 bg-amber-100  rounded-lg flex items-center justify-center mr-3 text-amber-600  text-sm font-bold">2</span>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="bg-slate-50  rounded-lg p-4">
                  <p className="text-sm text-slate-600 ">
                    <strong className="text-slate-900 ">Alcance:</strong> Primer marco legal integral sobre IA a nivel mundial
                  </p>
                </div>
              </div>
        ...
        <section id="rgpd" className="bg-white  rounded-xl border border-slate-200  p-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-lg font-semibold text-slate-900  mb-3">Derechos de los Interesados Relevantes para IA</h3>
              <div className="bg-slate-50  rounded-lg p-4 space-y-3">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-slate-900  text-sm">Derecho a la portabilidad</h4>
                    <p className="text-xs text-slate-600 ">Formatos interoperables</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Section 4: Checklist */}
        <section id="checklist" className="bg-white  rounded-xl border border-slate-200  p-6">
          <h2 className="text-2xl font-bold text-slate-900  mb-4 flex items-center">
            <span className="w-8 h-8 bg-amber-100  rounded-lg flex items-center justify-center mr-3 text-amber-600  text-sm font-bold">4</span>
          ...
          <div className="space-y-3">
            {[
              ...
              <label key={i} className="flex items-center bg-slate-50  rounded-lg p-4 cursor-pointer hover:bg-slate-100 transition-colors">
                <input type="checkbox" className="w-5 h-5 text-amber-600 border-slate-300  rounded focus:ring-amber-500 " />
        ...
        {/* Section 5: Recursos */}
        <section id="recursos" className="bg-white  rounded-xl border border-slate-200  p-6">
          <h2 className="text-2xl font-bold text-slate-900  mb-4 flex items-center">
            <span className="w-8 h-8 bg-amber-100  rounded-lg flex items-center justify-center mr-3 text-amber-600  text-sm font-bold">5</span>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="https://gdpr.eu/tag/gdpr/" target="_blank" rel="noopener noreferrer" className="text-amber-600  hover:underline text-sm flex items-center">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    </svg>
                    RGPD - gdpr.eu
                ...
                <li>
                  <a href="https://www.aepd.es" target="_blank" rel="noopener noreferrer" className="text-amber-600  hover:underline text-sm flex items-center">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    </svg>
                    Guía AEPD sobre IA
            ...
            <div>
              <h3 className="font-semibold text-slate-900  mb-3">Lecturas Recomendadas</h3>
