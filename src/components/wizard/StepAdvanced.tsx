    ...
    <div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            <label htmlFor="chunk-strategy" className="block text-sm font-medium text-slate-700  mb-2">
              Estrategia
            </label>
            <select
              id="chunk-strategy"
          ...
          <div>
            <label htmlFor="chunk-overlap" className="block text-sm font-medium text-slate-700  mb-2">
        ...
        <div className="space-y-6">
          ...
          <div>
            <label htmlFor="top-k" className="block text-sm font-medium text-slate-700  mb-2">
          ...
          <div className="flex items-center justify-between p-4 bg-slate-50  rounded-lg">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div className="w-11 h-6 bg-slate-300  peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
            </label>
          </div>
