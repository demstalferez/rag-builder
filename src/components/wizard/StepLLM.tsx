  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          <label htmlFor="llm-model" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
            Modelo
          </label>
          <select
            id="llm-model"
        ...
        <div>
          <label htmlFor="llm-temperature" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
      ...
      {config.llm.provider !== 'ollama' && (
        <div className="mt-6 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-lg">
          <p className="text-sm text-amber-800 dark:text-amber-200">
            <strong>Nota:</strong> Necesitaras configurar tu API key en el archivo <code className="bg-amber-100 dark:bg-amber-800 px-1 rounded">.env</code> despues de descargar el proyecto.
          </p>
        </div>
      )}
    </div>
