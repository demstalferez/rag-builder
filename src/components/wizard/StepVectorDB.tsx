  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          <label htmlFor="collection-name" className="block text-sm font-medium text-slate-700  mb-2">
        ...
        {(config.vectorDB.provider === 'qdrant' || config.vectorDB.provider === 'milvus') && (
          <div>
            <label htmlFor="db-port" className="block text-sm font-medium text-slate-700  mb-2">
              Puerto
            </label>
            <input
              id="db-port"
      ...
      {config.vectorDB.provider === 'pinecone' && (
        <div className="mt-6 p-4 bg-blue-50  border border-blue-200  rounded-lg">
          <p className="text-sm text-blue-800 ">
            <strong>Nota:</strong> Pinecone requiere una API key y configuracion de environment. Estos valores se configuraran en el archivo <code className="bg-blue-100  px-1 rounded">.env</code>.
          </p>
        </div>
      )}
